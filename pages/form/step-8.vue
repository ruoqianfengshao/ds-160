<template>
  <div class="min-h-screen bg-gray-50">
    <FormNavigation :current-step="8" step-title="Work/Education" />
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="card">
        <h2 class="text-2xl font-bold mb-6">Work/Education</h2>
        <p class="text-gray-600 mb-8">Complete this step to continue.</p>
        <form @submit.prevent="saveAndContinue" class="space-y-6">
          <p class="text-gray-500">Form fields for Work/Education will be displayed here.</p>
...
onMounted(() => { store.initializeFromStorage(); store.goToStep(8) })
</script>
